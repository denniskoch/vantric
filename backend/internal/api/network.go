...
func (s *Server) networkRoutes(r chi.Router) {
	...
	r.Get("/network/subnets/{id}/addresses", s.listSubnetAddresses)
	r.Put("/network/subnets/{id}/addresses", s.saveSubnetAddress)
	r.Delete("/network/subnets/{id}/addresses/{address}", s.deleteSubnetAddress)
